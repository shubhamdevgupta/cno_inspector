...
class Partbdwsmuserobservation extends StatefulWidget {
  @override
  _Partbdwsmuserobservation createState() => _Partbdwsmuserobservation();
}

class _Partbdwsmuserobservation extends State<Partbdwsmuserobservation> {
