                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Customradiobttn(
                                  ...
                                  onChanged: (val) =>
                                      setState(() => selectedVWSCFormed = val),
                                ),
                                Customradiobttn(
                                ...
                                Customradiobttn(
                                  ...
                                  onChanged: (val) => setState(
                                      () => selectedVWSCMeetingConducted = val),
                                ),
                                if (selectedVWSCMeetingConducted == "Yes")
                                  Customradiobttn(
                                    ...
                                    onChanged: (val) => setState(() =>
                                        selectedVWSCMeetingFrequency = val),
                                  ),
                                Customradiobttn(
                                  question:
                                  ...
                                  onChanged: (val) => setState(
                                      () => selectedVWSCRecordsAvailable = val),
                                ),
                                Customradiobttn(
                                ...
                                CustomMultiSelectChipQuestion(
                                  ...
                                  onSelectionChanged: (valList) => setState(
                                      () => selectedOMArrangements = valList),
                                ),
                                Customradiobttn(
                                  question:
                                  ...
                                  onChanged: (val) => setState(
                                      () => selectedCommunityAwareness = val),
                                ),
                                Customradiobttn(
                                  question:
