...
class _CommunityInvolvementPartBState extends State<CommunityInvolvementPartB> {
                                ...
                                children: [
                                  ...
                                  Customradiobttn(
                                    ...
                                    onChanged: (val) {
                                      ...
                                      print('selectedVWSCFormed------- ${vwscProvider.selectedVWSCFormed} : ${vwscProvider.selectedVWSCFormedID}');
                                    },
                                  ...
                                  Customradiobttn(
                                    ...
                                    options: vwscProvider.yesNoMap.keys.toList(),
                                    selectedOption: vwscProvider.selectedVWSCBankAccount,
                                    onChanged: (val) {
                                  ...
                                  Customradiobttn(
                                    ...
                                    onChanged: (val) {
                                      ...
                                      print(
                                          'selectedAsBuiltDrawingID------- ${vwscProvider
  ...
  Widget buildRadioGroup(String title,
      List<String> options,
      String? groupValue,
