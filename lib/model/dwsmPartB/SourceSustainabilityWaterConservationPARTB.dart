class SourceSustainabilityWaterConservation {
  ...
  factory SourceSustainabilityWaterConservation.fromJson(
    ...
    return SourceSustainabilityWaterConservation(
        ...
        areSourceSustainabilityMeasuresBeingPromoted:
            json['are_source_sustainability_measures_being_promoted'],
        arePipedWaterSchemesGwSourcesProtectedContamination:
            json['are_piped_water_schemes_gw_sources_protected_contamination'],
        isAtLeastOneRechargeStructureGwSourceImplemented:
            json['is_at_least_one_recharge_structure_gw_source_implemented'],
        ifNoLeastOneRechargeStructureGwSourceImplementedReson: json[
            'if_no_least_one_recharge_structure_gw_source_implemented_reson'],
        areAnyImpactStudiesAssessmentsConductedSourceSustainEfforts: json[
            'are_any_impact_studies_assessments_conducted_source_sustain_efforts'],
        accrediteLabWaterQuality:
            json['Does_district_NABL_accredited_lab_water_quality'],
        accrediteLabWaterQualityNoRemark:
            json['Does_district_NABL_accredited_lab_water_quality_no_remark'],
