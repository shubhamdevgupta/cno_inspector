class SourceSustainabilityWaterConservation {
  ...
  factory SourceSustainabilityWaterConservation.fromJson(
    ...
    return SourceSustainabilityWaterConservation(
      ...
      ifNoLeastOneRechargeStructureGwSourceImplementedReson:
      json['if_no_least_one_recharge_structure_gw_source_implemented_reson'],
      areAnyImpactStudiesAssessmentsConductedSourceSustainEfforts:
      json['are_any_impact_studies_assessments_conducted_source_sustain_efforts'],
    );
  }
}
